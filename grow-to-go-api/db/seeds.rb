...
neon_pothos = Plant.create(name: "Neon Pothos", species: "Epipremnum Aureum", price: 20, exp_level: "Beginner", size: "Mini", light_required: "Low to Medium Indirect", image: "https://cdn.shopify.com/s/files/1/0150/6262/products/the-sill_neon-pothos_grant_blush_5_1500x.progressive.jpg?v=1566928489")

snake_plant = Plant.create(name: "Petite Snake Plant", species: "Sansevieria", price: 25, exp_level: "Beginner", size: "Mini", light_required: "Medium Indirect", image: "https://cdn.shopify.com/s/files/1/0150/6262/products/the-sill_potted-plant_cylindrical-snake-plant_ezra_mint_1500x.progressive.jpg?v=1560530525")

silver = Plant.create(name: "Silver Philodendron", species: "Scindapsus Pictus", price: 25, exp_level: "Beginner", size: "Mini", light_required: "Medium Indirect", image: "https://cdn.shopify.com/s/files/1/0150/6262/products/the-sill_potted-plant_silver-philodendron_grant_mustard-4_1500x.progressive.jpg?v=1565297788")
...
monstera = Plant.create(name: "Monstera", species: "Monstera Deliciosa", price: 60, exp_level: "Beginner", size: "Medium", light_required: "Bright Indirect", image: "https://cdn.shopify.com/s/files/1/0150/6262/products/the-sill_potted-plant_monstera-6_hyde_mint_7_1500x.progressive.jpg?v=1564151052")

alocasia_polly = Plant.create(name: "Alocasia Polly", species: "Alocasia 'Polly'", price: 40, exp_level: "Advanced", size: "Small", light_required: "Medium Indirect", image: "https://cdn.shopify.com/s/files/1/0150/6262/products/the-sill_alocasia-polly_august_blush_4_1500x.progressive.jpg?v=1566848403")
